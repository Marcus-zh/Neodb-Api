...
def getdata():
    ...
    if token and type:
        try:
            # 构建不同类型的键
            pagedata = f"page-{page}-{type}-{cate}"
        ...
        print("缺失 type，详情请见 https://blog.marcus233.top/wiki/neodbapi/index.html")
        return {
            "code": 0,
            "msg": "缺失 type，详情请见 https://blog.marcus233.top/wiki/neodbapi/index.html"
        }, 400
